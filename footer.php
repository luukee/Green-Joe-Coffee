...
for (i = 0; i < acc.length; i++) {
  acc[i].addEventListener("click", function() {
	...
	<script>
		...
		jQuery(".woocommerce #customer_login .u-column1").addClass("form-coman");
		jQuery(".woocommerce #customer_login .u-column2").addClass("form-coman");
		jQuery(".fusion-main-menu-cart .fusion-menu-cart-items .fusion-menu-cart-checkout").addClass("fusion-menu-cart-item");
		jQuery(".fusion-menu-cart-items .fusion-menu-cart-checkout-link").addClass("fusion-menu-cart-link");
		jQuery(".woocommerce .lost_reset_password .form-row-first").addClass("user_input_field");
		jQuery(".post-content .lost_reset_password .form-row").addClass("user_button_field");
		jQuery("").addClass("");
		});
	</script>
</html>